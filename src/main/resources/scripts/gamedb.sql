...
CREATE TABLE `activity_lottery` (
  ...
  `item_title` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '奖项名称',
  `item_img_url` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '奖项图片',
  ...
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='大转盘配置表';
...
CREATE TABLE `activity_lottery_info` (
  ...
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='大转盘获奖记录表';
...
CREATE TABLE `agent_goldenbean` (
  ...
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='代理商金豆表';
...
CREATE TABLE `agent_goldenbean_info` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='代理商金豆明细表';
...
CREATE TABLE `agent_info` (
  ...
  `agent_name` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '代理商名称',
  `agent_code` int(8) NOT NULL COMMENT '代理商编码',
  `qq` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT 'QQ号码',
  `agent_desc` varchar(200) COLLATE utf8mb4_bin NOT NULL COMMENT '商家说明',
  ...
  `agent_account` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '登录账户',
  `agent_password` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '登录密码',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`agent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='代理商信息表';
...
CREATE TABLE `base_banner` (
  ...
  `banner_url` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '图片地址',
  `banner_links` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '图片链接配置',
  `banner_index` tinyint(2) NOT NULL COMMENT '图片排序位',
  `banner_status` tinyint(1) NOT NULL COMMENT '图片状态',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`banner_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='banner广告图';
...
CREATE TABLE `base_lottery_info` (
  ...
  `lottery_title` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '福利标题',
  `lottery_content` text COLLATE utf8mb4_bin NOT NULL COMMENT '福利内容',
  `begin_date` date NOT NULL COMMENT '活动开始日期',
  `end_date` date NOT NULL COMMENT '活动结束日期',
  `img_url` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '活动宣传图片地址',
  `target_member` tinyint(1) NOT NULL COMMENT '活动参与对象',
  `lottery_status` tinyint(1) NOT NULL COMMENT '活动状态',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`lottery_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='玩家福利列表';
...
CREATE TABLE `base_news` (
  ...
  `news_title` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT '新闻标题',
  `news_date` datetime NOT NULL COMMENT '新闻时间',
  `news_content` varchar(2000) COLLATE utf8mb4_bin NOT NULL COMMENT '新闻内容',
  `news_status` tinyint(1) NOT NULL COMMENT '新闻状态',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`news_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='新闻公告表';
...
CREATE TABLE `game_data_source` (
  ...
  `source_name` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '数据源名称',
  `source_desc` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '数据源描述',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏数据源表';
...
CREATE TABLE `game_info` (
  ...
  `game_name` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '游戏名称',
  `game_help` varchar(2000) COLLATE utf8mb4_bin NOT NULL COMMENT '游戏帮助',
  `game_time` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '游戏时间',
  ...
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`game_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏信息表';
...
CREATE TABLE `game_info_options` (
  ...
  `option_title` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '选项标题',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏投注项';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='开奖数据源记录表';
...
CREATE TABLE `game_phase` (
  ...
  `phase_no` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '游戏期数编号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏期数信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='玩家投注表';
...
CREATE TABLE `game_result_rule_10` (
  ...
  `gmt_modify` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏开奖结果-群数第一位 10';
...
CREATE TABLE `game_result_rule_11` (
  ...
  `gmt_modify` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏开奖结果-二数求和 11';
...
CREATE TABLE `game_result_rule_28` (
  ...
  `gmt_modify` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏开奖结果-三数求和-28';
...
CREATE TABLE `game_result_rule_29` (
  ...
  `gmt_modify` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏开奖结果-三数求和-16';
...
CREATE TABLE `game_result_rule_36` (
  ...
  `gmt_modify` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏开奖结果-三数组合类分类 36';
...
CREATE TABLE `game_type` (
  ...
  `type_summary` varchar(200) COLLATE utf8mb4_bin NOT NULL COMMENT '类型描述',
  `type_content` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '游戏介绍',
  `type_status` tinyint(1) NOT NULL COMMENT '类型状态',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  `org_type` bigint(11) NOT NULL COMMENT '数据源类型',
  `org_code` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '数据源业务编码',
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='游戏类型表';
...
CREATE TABLE `member_account_change` (
  ...
  `info_desc` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员金豆和银行账户转账记录';
...
CREATE TABLE `member_almsbean_info` (
  ...
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员每日救济金豆领取记录表';
...
CREATE TABLE `member_bankcard` (
  ...
  PRIMARY KEY (`card_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员银行账户表';
...
CREATE TABLE `member_bankcard_info` (
  ...
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员银行账户明细表';
...
CREATE TABLE `member_goldenbaen` (
  ...
  PRIMARY KEY (`bean_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员金豆账户表';
...
CREATE TABLE `member_goldenbean_info` (
  ...
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员金豆账户明细表';
...
CREATE TABLE `member_info` (
  ...
  `member_name` varchar(8) COLLATE utf8mb4_bin NOT NULL COMMENT '会员编码',
  `member_nickname` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '会员昵称',
  `user_name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '真实姓名',
  `member_icon_url` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '头像',
  `member_mobile` varchar(11) COLLATE utf8mb4_bin NOT NULL COMMENT '手机号码',
  `member_qq` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'QQ',
  `member_email` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '常用邮箱',
  `member_wx` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '微信',
  ...
  `extend_links` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '推广链接地址',
  `parent_id` bigint(11) DEFAULT NULL COMMENT '上级会员ID',
  `last_ip` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '上次登录ip地址',
  `last_logintime` datetime DEFAULT NULL COMMENT '上次登录时间',
  `singin_counts` tinyint(1) DEFAULT '0' COMMENT '连续签到数',
  `login_pass` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '登录密码',
  `bank_pass` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '银行密码',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员表';
...
CREATE TABLE `member_level_agent` (
  ...
  `level_name` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '等级名称',
  `level_score` int(3) NOT NULL COMMENT '等级抽成比例 0-999',
  `level_status` tinyint(1) NOT NULL COMMENT '等级状态 -1删除 0停用 1有效',
  `gmt_create` datetime NOT NULL,
  `gmt_modified` datetime NOT NULL,
  PRIMARY KEY (`level_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='代理会员等级（直充模式下代理玩家各个等级的配置信息）';
...
CREATE TABLE `member_level_player` (
  ...
  `level_title` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '等级标题',
  ...
  PRIMARY KEY (`level_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='玩家会员等级表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='玩家关系族谱表';
...
CREATE TABLE `member_signin_info` (
  ...
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员签到记录表';
...
CREATE TABLE `member_xp_info` (
  ...
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员经验值明细表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='会员经验兑换金豆记录表';
...
CREATE TABLE `order_goods` (
  ...
  `goods_name` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT '商品名称',
  `goods_price` bigint(11) NOT NULL COMMENT '商品金额展示使用',
  `goods_img_url` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '商品图片',
  `goods_beans` bigint(11) NOT NULL COMMENT '商品价格（金豆数）',
  `goods_desc` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '奖品说明',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='商品表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='玩家购买商品表';
...
CREATE TABLE `plam_verification_code` (
  ...
  `mobile_no` varchar(11) COLLATE utf8mb4_bin NOT NULL COMMENT '手机号码',
  `code_info` varchar(6) COLLATE utf8mb4_bin NOT NULL COMMENT '验证码',
  `limit_time` datetime NOT NULL COMMENT '有效期限',
  `code_status` tinyint(1) NOT NULL COMMENT '记录状态',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`code_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='验证码记录表';
...
CREATE TABLE `security_token` (
  ...
  `account` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '登录账户',
  `login_time` datetime NOT NULL COMMENT '登录时间',
  `login_ip` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '登录ip',
  `login_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳',
  `token_content` varchar(256) COLLATE utf8mb4_bin NOT NULL COMMENT 'token',
  `limit_time` bigint(20) NOT NULL COMMENT '有效时间',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '最后修改时间',
  `token_status` tinyint(1) NOT NULL COMMENT '记录状态',
  PRIMARY KEY (`token_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='用户授信记录表';
...
CREATE TABLE `sys_log` (
  ...
  `log_sys` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '1 运营端（oss）\r\n            2 代理端（agent）\r\n            3 客户端（PC）\r\n            4 客户端（App）',
  `log_module` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '模块记录对应着相关的模块列表（此列表目前不在库中保存，后续添加进来）',
  `log_function` varchar(20) COLLATE utf8mb4_bin NOT NULL COMMENT '功能名称',
  `log_user_id` bigint(11) NOT NULL COMMENT '操作人ID',
  `log_biz_message` varchar(500) COLLATE utf8mb4_bin NOT NULL COMMENT '具体业务操作描述',
...
CREATE TABLE `sys_menu` (
  ...
  `menu_desc` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '菜单描述',
  `menu_url` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '菜单链接地址',
  ...
  `gmt_modified` datetime NOT NULL,
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='系统菜单表（系统权限控制在菜单级）';
...
CREATE TABLE `sys_relation_role_resource` (
  ...
  `gmt_modified` datetime NOT NULL,
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='角色具有权限表（目前角色只配置到菜单，后续可以扩展配置到功能级）';
...
CREATE TABLE `sys_relation_user_role` (
  ...
  `gmt_modified` datetime NOT NULL,
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='用户具有角色记录表';
...
CREATE TABLE `sys_role` (
  ...
  `role_desc` varchar(500) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `sys_user` (
  ...
  `user_mobile` varchar(11) COLLATE utf8mb4_bin NOT NULL COMMENT '联系手机号码',
  `user_email` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '电子邮箱',
  `user_account` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '登录账户',
  `user_password` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '登录密码（64位加密）',
  `user_status` tinyint(1) NOT NULL COMMENT '用户状态-1删除 0停用 1有效',
  `gmt_create` datetime NOT NULL,
  `gmt_modified` datetime NOT NULL,
  `last_login_ip` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用户最后登录IP地址',
  `last_login_time` datetime DEFAULT NULL COMMENT '用户最后登录时间',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='系统用户表';

-- ----------------------------
--  Records of `sys_user`
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES ('1', '测试用户1', '13333456789', '123@qq.om', '123123123', '123123123', '1', '2019-05-14 16:29:04', '2019-05-14 16:29:04', null, null), ('2', '用户1', '23453123', '123124@qw.com', '123123132213', '34234234', '1', '2019-05-14 16:39:22', '2019-05-14 16:44:19', null, null);
COMMIT;
