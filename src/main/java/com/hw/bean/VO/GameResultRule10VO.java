...
* @description: [数据库View BEAN]游戏开奖结果-群数第一位 10
**/

@Data
public class GameResultRule10VO implements Serializable {

    private static final long serialVersionUID = -3087013382583857804L;
    /**
    *   出奖记录ID
    */
