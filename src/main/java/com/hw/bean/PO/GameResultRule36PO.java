...
* @description: [数据库实体BEAN]游戏开奖结果-三数组合类分类 36
**/

@Data
public class GameResultRule36PO implements Serializable {

    private static final long serialVersionUID = -5577578791237745133L;
    /**
    *   出奖记录ID
    */
