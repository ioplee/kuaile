...
* @description: 大转盘定义表 DAO 数据库操作对象 Mybatis接口
**/

public interface ActivityLotteryDAO{

    /**
    * Insert integer.  添加 大转盘定义表 记录
    *
    * @param activityLotteryPO  大转盘定义表 数据实体对象
    * @return the integer  返回操作结果,1代表成功 0代表失败
    */
    public Integer insertActivityLottery(ActivityLotteryPO activityLotteryPO);

    /**
    * Update integer.  修改大转盘定义表 记录
    *
    * @param activityLotteryPO  大转盘定义表 数据实体对象
    * @return the integer  返回操作结果,1代表成功 0代表失败
    */
    ...
    * Select list list.
    *
    * @param query 获取大转盘定义表列表记录BO
    * @return the list  返回大转盘定义表记录集合
    */
    public List<ActivityLotteryVO> getPageList(QueryActivityLotteryPage query);

    /**
    * Select by primary key 大转盘定义表 vo.
    *
    * @param PRI 记录ID
    * @return the ActivityLotteryVO  指定 大转盘定义表 信息VO
    */
