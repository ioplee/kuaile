...
* @description: 会员经验兑换金豆记录表 DAO 数据库操作对象 Mybatis接口
**/

public interface MemberXpToBeanDAO{

    /**
    * Insert integer.  添加 会员经验兑换金豆记录表 记录
    *
    * @param memberXpToBeanPO  会员经验兑换金豆记录表 数据实体对象
    * @return the integer  返回操作结果,1代表成功 0代表失败
    */
    public Integer insertMemberXpToBean(MemberXpToBeanPO memberXpToBeanPO);

    /**
    * Update integer.  修改会员经验兑换金豆记录表 记录
    *
    * @param memberXpToBeanPO  会员经验兑换金豆记录表 数据实体对象
    * @return the integer  返回操作结果,1代表成功 0代表失败
    */
    ...
    *
    * @param query 获取会员经验兑换金豆记录表列表总记录数BO
    ...
    * Select list list.
    *
    * @param query 获取会员经验兑换金豆记录表列表记录BO
    * @return the list  返回会员经验兑换金豆记录表记录集合
    */
    public List<MemberXpToBeanVO> getPageList(QueryMemberXpToBeanPage query);

    /**
    * Select by primary key 会员经验兑换金豆记录表 vo.
    *
    * @param PRI 记录ID
    * @return the MemberXpToBeanVO  指定 会员经验兑换金豆记录表 信息VO
    */
