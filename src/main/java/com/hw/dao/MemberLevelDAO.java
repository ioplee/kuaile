...
* @description: 会员等级表 DAO 数据库操作对象 Mybatis接口
**/

public interface MemberLevelDAO{

    /**
    * Insert integer.  添加 会员等级表 记录
    *
    * @param memberLevelPO  会员等级表 数据实体对象
    * @return the integer  返回操作结果,1代表成功 0代表失败
    */
    public Integer insertMemberLevel(MemberLevelPO memberLevelPO);

    /**
    * Update integer.  修改会员等级表 记录
    *
    * @param memberLevelPO  会员等级表 数据实体对象
    * @return the integer  返回操作结果,1代表成功 0代表失败
    */
    ...
    * Select list list.
    *
    * @param query 获取会员等级表列表记录BO
    * @return the list  返回会员等级表记录集合
    */
    public List<MemberLevelVO> getPageList(QueryMemberLevelPage query);

    /**
    * Select by primary key 会员等级表 vo.
    *
    * @param PRI 记录ID
    * @return the MemberLevelVO  指定 会员等级表 信息VO
    */
